...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application Car
...
#--- OIL file
oilSourceList.append("mycar.oil")
...
cSourceList.append(projfile.ProjectFile("mycar.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("mycar/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("mycar/tpl_os.c"))
