...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application Car
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file mycar.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates/ mycar.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("mycar/tpl_app_config.c")

sourceList.append("mycar/tpl_os.c")
